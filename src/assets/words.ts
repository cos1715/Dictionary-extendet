...
export const words: IWord[] = [
  ...
  },
  {
    ...
    ukr: 'битка',
    definition:
      'an implement with a handle and a solid surface, typically of wood, used for hitting the ball in games'
  },
  {
    eng: 'bed',
    ukr: 'ліжко',
  ...
  },
  {
    ...
    ukr: 'банка',
    definition:
      'a wide-mouthed cylindrical container made of glass, metal or pottery'
  },
  {
    eng: 'jeep',
    ukr: 'джип',
  ...
  },
  {
    ...
    ukr: 'зодіак',
    definition:
      'eavens centered on the ecliptic that encompasses the apparent paths of all the planets and is divided into 12 constellations or signs each taken for astrological purposes to extend 30 degrees of longitude'
  },
  {
    eng: 'zoo',
    ukr: 'зоопарк',
